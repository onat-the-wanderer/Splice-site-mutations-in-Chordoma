---
title: "DEG_analysis_for_skull_samples"
...
```{r}
setwd("Desktop/project/skullbase/skullbase_count_data/")
```

count data is loaded.
```{r}
data <- read.csv(file = "counts_skull_new.csv", sep = ";", header=T,fill=T,row.names = NULL)
colnames(data) <- c(" ","SRR5714750","SRR5714788","SRR5714753","SRR5714751","SRR5714762","SRR5714740","SRR5714792","SRR5714793","SRR5714794","SRR5714796")
data2 <- data[,-1]
...
meta data is loaded.
```{r}
tissue <- c("skull", "skull", "skull","skull", "skull","turbinate" ,"turbinate", "turbinate","turbinate", "turbinate")
condition <- c( "chordoma", "chordoma", "chordoma", "chordoma", "chordoma","normal", "normal", "normal","normal", "normal")
metadata <- data.frame(tissue, condition)
rownames(metadata) <- c("SRR5714750","SRR5714788","SRR5714753","SRR5714751","SRR5714762","SRR5714740","SRR5714792","SRR5714793","SRR5714794","SRR5714796")
```
...
DE_result <-results(deseq2Obj_DE, 
                    contrast = c("condition", "chordoma", "normal"),
                    alpha = 0.05)
